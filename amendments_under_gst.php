...
<section class="page-title page-title-1" id="page-title">
    <div class="page-title-wrap bg-overlay bg-overlay-dark-2">
        <div class="bg-section"><img src="assets/images/page-titles/GST.jpg" alt="Background" /></div>
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">AMENDMENT UNDER GST </h1>
                        <p class="title-desc">Non-core fields are fields in the registration application that do not include the legal name of the business, the addition/ deletion of shareholder details, and the major place of business or additional place of business. Non-core fields can be edited, and changes are automatically reflected in the taxpayer's registration.The Tax Officials must approve any changes to Core fields. The following are examples of core fields: Any change in the legal/trade name of the business that does not result in a change in the PAN. The main place of business. Additional Business Location (Other than change in State)</p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">AMENDMENT UNDER GST </p>
                    <!-- <h2 class="heading-title">When there is a change in PAN, an application for Amendment of Registration cannot be filed. </h2> -->
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="block-left">
                                <p class="paragraph">Several variables, such as a change in address, change in contact number, change in business data, and so on, may need modifications to the registration once the applicant has been registered under GST. A taxpayer must file an Application for Amendment of Registration to change any information after it has been registered.</p>
                                <p class="paragraph">There are two sorts of applications for registration amendments: Application for Changes to Registration's Core Fields Application for Non-Core Fields in Registration to be Modified</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p>When there is a change in PAN, an application for Amendment of Registration cannot be filed. A change in the business's structure necessitates a change in the PAN. Change of business location from one state to another.</p>
                                    <!-- <ul class="list-unstyled advantages-list">
                                        <li>legally recognized as supplier of goods or Services </li>
                                        <li>legally authorized to collect tax from his customers and pass on the credit of the Taxes </li>
                                        <li>claim input tax credit of taxes paid</li>
                                        <li>Seamless flow of Input Tax Credit </li>
