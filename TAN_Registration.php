                    ...
                    <div class="slide-content">
                        <div class="row">
                            <div class="col-12 col-lg-7">
                                <h1 class="slide-headline">TAN</h1>
        ...
        <div class="row">
            <div class="col-12 col-lg-12">
                <div class="heading heading-12">
                    <p class="heading-subtitle" style="font-size: 33px; text-align: justify;">Purpose:
                    </p>
                </div>
                <div class="about-block">
                    <div class="block-left">
                        <p class="paragraph">The TAN, which stands for Tax Deduction and Collection Account Number, is a 10-digit
                            alpha numeric number. TDS/TCS returns (including any e-TDS/TCS returns), TDS/TCS
                            payment challans, and TDS/TCS certificates must all include the TAN.</p>

                    </div>
                    <div class="block-left">
                        <p class="paragraph">All individuals who are obligated to deduct or collect tax at source on behalf of the Income
                            Tax Department must apply for and get a TAN.</p>

                    </div>
                    <div class="block-left">
                        <p class="paragraph">Section 203A of the Income Tax Act mandates that everyone who deducts or collects tax at
                            source apply for a TAN. The clause also mandates that the TAN be included in all TDS/TCS
                            returns, payment challans, and certificates. A penalty of Rs. 10,000/- is imposed for failing to
                            apply for a TAN or complying with any of the other provisions of the section</p>

                    </div>
                    <div class="block-left">
                        <p class="paragraph">All TDS/TCS returns, payment challans, and TDS/TCS certifications must include the TAN
                            number. If the TAN is not quoted, TDS/TCS returns will not be received, and challans for
                            TDS/TCS payments will not be acknowledged by banks. A penalty of Rs. 10,000/- will be
                            imposed if you do not apply for a TAN or do not quote it in the required paperwork.
                        </p>
                    </div>
                </div>
...
<section class="about about-3" id="about-3">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-12">
                    <p class="heading-subtitle" style="font-size: 33px; text-align: justify;">Applicability
                ...
                <div class="about-block">
                    <div class="block-left">
                        <p class="paragraph">All those who are required to deduct or collect tax at source on behalf of the Income Tax
                            department need to apply and obtain the 10-digit alphanumeric. It is to be taken by all
                            businesses which needs to deposit tax at source, whether it is a small or big organisation.
                            The amount deducted in the form of tax is thus deposited to the central government.
                        </p>
                ...
                <div class="heading heading-12">
                    <p class="heading-subtitle" style="font-size: 33px; text-align: justify;">Benefits
                    </p>
                </div>
                ...
                <div class="about-block">
                    <div class="block-left">
                        <p class="paragraph">A deductor, or a person or business that deducts tax at source on a specific date, can
                            simply get communication from the Income Tax Department about tax collected at source
                            (TCS) and tax deducted at source (TDS) from the database of active TAN details.
                        </p>
                    </div>

                    <div class="block-left">
                        <p class="paragraph">Each deductor will have their own secure login area.
                        </p>
                    </div>

                    <div class="block-left">
                        <p class="paragraph">Deductors will also be able to download the most recent Input file (FVU) for the purpose
                            of writing corrective statements and checking the challan status online, as described
                            below.
                        </p>
                    </div>
...
<section class="about about-3" id="about-3">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-12">
                <div class="heading heading-12">
                    <p class="heading-subtitle" style="font-size: 33px; text-align: justify;">Procedure for TAN Registration
                ...
                <div class="about-block">
                    <div class="block-left">
                        <p class="paragraph">Visit www.tin-nsdl.com/index.html
                        </p>
                    </div>

                    <div class="block-left">
                        <p class="paragraph">Select ‘TAN’ under the ‘Services’ dropdown
                        </p>
                    </div>

                    <div class="block-left">
                        <p class="paragraph">Click on ‘Apply Online’
                        </p>
                    </div>

                    <div class="block-left">
                        <p class="paragraph">Select ‘New TAN’
                        </p>
                    </div>
                    <div class="block-left">
                        <p class="paragraph">On the new page, choose from the list ‘category of deductors’ and click on ‘Select’
                        </p>
                    </div>
                    <div class="block-left">
                        <p class="paragraph">In doing so, you are redirected to Form 49B
                        </p>
                    </div>
                    <div class="block-left">
                        <p class="paragraph">Fill in the form and click ‘Submit’
                        </p>
                    </div>
                    <div class="heading heading-12">
                        <p style="font-weight: 500; color: black; font-size: 19px;">On confirmation, an acknowledgement screen is displayed which contains </p>
                    </div>
                    <div class="block-left">
                        <p class="paragraph">
                        </p>
                        <ul>
                            <p class="paragraph">A 14-digit acknowledgement number</p>
                            <p class="paragraph">Status of the applicant</p>
                            <p class="paragraph">Name of the applicant</p>
                            <p class="paragraph">Contact details</p>
                            <p class="paragraph">Payment details</p>
                            <p class="paragraph">Space of signature</p>
                    ...
                    <div class="block-left">
                        <p class="paragraph">The applicant is required to save the acknowledgement and get a printout of it
                        </p>
                    </div>

                    <div class="block-left">
                        <p class="paragraph"> The printout of the acknowledgement along with other documents is required to be
                            sent to Protean eGov Technologies Limited at –
                        </p>
                    </div>
                    ...
                    <div class="heading heading-12">
                        <p style="font-weight: 500; color: black; font-size: 19px;">Protean eGov Technologies Limited Infrastructure Limited</p>
                    </div>

                    <div class="about-block">
                        <div class="block-left">
                            <p class="paragraph">5th floor, Mantri Sterling <br>
                                Plot No.341, Survey No.997/98, <br>
                                Model Colony <br>
                                Near Deep Bungalow Chowk <br>
                    ...
                    <div class="about-block">
                        <div class="block-left">
                            <p class="paragraph"> For applying offline, the process is the same as mentioned above apart from the fact that the
                                applicant is required to visit the TIN facilitation centers located in their place of residence.
                    ...
                    <div class="heading heading-12">
                        <p style="font-weight: 500; color: black; font-size: 19px;">For applying physically -- </p>
                    </div>

                    <div class="about-block">
                        <div class="block-left">
                            <p class="paragraph">The application form i.e., Form 49B can be obtained from any of the TIN facilitation centers
                                or can be simply downloaded by visiting www.tin-nsdl.com/index.html
                            </p>
                        </div>
                    </div>

                    <div class="heading heading-12">
                        <p style="font-weight: 500; color: black; font-size: 19px;">Fee for processing TAN application --
                        </p>
                    </div>

                    <div class="about-block">
                        <div class="block-left">
                            <p class="paragraph">The processing fee for both type of applications i.e., issuance of new TAN and for change or
                                correction in TAN data for TAN allotted is Rs.65 (Rs.55 application charge + 18% Goods
                                and Services TAX).
                            </p>
                        </div>
                    </div>
