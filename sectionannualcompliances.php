            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        ...
                        <p class="title-desc">A Section 8 corporation is a non-profit corporation founded to promote trade, the arts, science, sports, education, research, social welfare, and environmental protection.
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-7">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg"></p>
                    <h2 class="heading-title">Section 8 Annual Compliance</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">Appointment of Auditor The appointment of an auditor is required for all businesses. The company's books of accounts and annual returns will be audited by a statutory auditor who will be appointed for a five-year term.</p><a class="btn btn--secondary" href="#">read more <i class="energia-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p class="text-dark">Maintenance of Register: The company is required to maintain a statutory register consisting of members, loans obtained etc.
        ...
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    ...
                    <p class="text-white"><b>Appointment of Auditor </b></p>
                    <p class="heading-desc">The appointment of an auditor is required for all businesses. The company's books of accounts and annual returns will be audited by a statutory auditor who will be appointed for a five-year term</p>

                    <p class="text-white"><b>Maintenance of Register </b></p>
                    <p class="heading-desc">The company is required to maintain a statutory register consisting of members, loans obtained etc.

                    </p>
                    <p class="text-white"><b>Convening Meetings </b></p>
                    <p class="heading-desc">Annual general body meeting is to be conducted once a year within 6 months of the end of financial year
                ...
                <div class="col-12 col-lg-6 offset-lg-1">
                    ...
                    <p class="text-white"><b>Report by Directors</b></p>
                    <p class="heading-desc">The company's Board of Directors must file its annual report, which includes all financial statements and other annexures, in a timely manner. The board report must be submitted on Form AOC-4. </p>

                    <p class="text-white"><b>Financial Statement of the company </b></p>
                    <p class="heading-desc">The appointment of an auditor is required for all businesses. The company's books of accounts and annual returns will be audited by a statutory auditor who will be appointed for a five-year term</p>
                    <p class="text-white"><b>Appointment of Auditor </b></p>
                    <p class="heading-desc">The appointment of an auditor is required for all businesses. The company's books of accounts and annual returns will be audited by a statutory auditor who will be appointed for a five-year term</p>
