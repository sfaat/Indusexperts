        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">PRIVATE LIMITED COMPANY TO PUBLIC LIMITED COMPANY</h1>
                        <p class="title-desc">A private limited company, or LTD, is a firm that is privately owned. This means that the company's liability is limited to its shares, and the number of shareholders is limited to 50. It also prohibits stockholders from publicly exchanging their shares. </p>
            ...
            <div class="col-lg-12">
                <div class="jumbotron">
                    <div class="card p-5 my-2">
                        ...
                        A PLC (Public Limited Company) is a publicly traded corporation. It is a public limited company with publicly traded shares. PLC might be listed on the stock exchanges or not. A minimum of three directors is required by PLC.
                        </div>
                    </div>
                    ...
                    <div class="card p-5 my-2">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled advantages-list">
                                <li style="color: black;"> There is no restriction in the transferability of shares as it is open to public.</li>
                                <li style="color: black;">The scope for a PLC is vast in comparison to limited number of people for a Private Limited Company.</li>
                                <li style="color: black;">Capital for PLC can be raised from the general public, giving it more opportunity for growth and success.</li>
                                <li style="color: black;">Systemized functioning will help in building the business and good team work</li>
                            </ul>
                    ...
                    <div class="card p-5 my-2">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled advantages-list">
                                <li style="color: black;">DSC for 1 Director.</li>
                                <li style="color: black;">Minimum 7 Shareholders.</li>
                                <li style="color: black;">	DIN for all directors.</li>
                                <li style="color: black;">Minimum Authorized Share Capital of Rs 5lacs</li>
                                <li style="color: black;">	Minimum Paid up Share Capital of Rs.5lacs</li>
                                <li style="color: black;">Director and shareholder can be the same person.</li>
                                <li style="color: black;">Minimum 3 Directors</li>
