        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">GST AUDIT AND ANNUAL RETURN</h1>
                        <p class="title-desc"> audit means the examination of records, returns and other documents maintained or furnished by the registered person under this Act or the rules made thereunder or under any other law for the time being in force to verify the correctness of turnover declared, taxes paid, refund claimed and input tax credit availed, and to assess his compliance with the provisions of this Act or the rules made there under.</p>
...
<section class="about about-1 my- py-3" id="about-1">
    <div class="container">
        <div class="row">
            <!-- <div class="col-12 col-lg-5">
                <div class="about-img">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">GST AUDIT AND ANNUAL RETURN</p>
                    
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="block-left">
                                <p class="paragraph">An audit under GST is the process of examining a taxable person's records, returns, and other documentation. The goal is to ensure that the turnover declared, taxes paid, refunds claimed, and input tax credits claimed are valid, as well as to check compliance with GST regulations. Every registered taxable person whose annual turnover exceeds the statutory limit [the turnover limit in the current GST Rules is above Rs 2 crore] must have his accounts audited by a chartered accountant or a cost accountant.</p>
                                <p class="paragraph">We have continued our evolution with the dynamic legal framework and worked intensively in developing professional knowledge and human resources, necessary to undertake GST audits of a wide array of clients across diverse industries.</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p>Except for a few exceptions, all registered GST taxpayers must file a GSTR-9 yearly return. It is a yearly compilation of outbound and inbound supply, tax liability, and input tax credit received within a fiscal year. It must be filed by the 31st of December of the year after the financial year in question.</p>
            ...
            <div>
                <div class="feature-panel-holder" data-hover="">
                    <div class="feature-panel">
                        ...
                        <div class="feature-content">
                            <h4>Turnover based Audit</h4>
                            <p>Chartered Accountant or Cost Accountant appointed by the taxpayer</p>
                        </div><a href="page-about.html"><i class="energia-arrow-right"></i> <span>explore more</span> </a>
                    </div>
            ...
            <div>
                <div class="feature-panel-holder" data-hover="">
                    <div class="feature-panel">
                        ...
                        <div class="feature-content">
                            <h4>Normal audit/General Audit</h4>
                            <p>Commissioner of CGST/SGST or any Officer authorized by him.</p>
                        </div><a href="page-about.html"><i class="energia-arrow-right"></i> <span>explore more</span> </a>
                    </div>
            ...
            <div>
                <div class="feature-panel-holder" data-hover="">
                    <div class="feature-panel">
                        ...
                        <div class="feature-content">
                            <h4>Special audit</h4>
                            <p>A Chartered Accountant or Cost Accountant, nominated by Commissioner</p>
                        </div><a href="page-about.html"><i class="energia-arrow-right"></i> <span>explore more</span> </a>
                    </div>
