        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">INPUT TAX CREDIT </h1>
                        <p class="title-desc">Input Tax Credit refers to obtaining a credit for GST paid on goods and services purchased for the purpose of running a business. The Input Tax Credit Mechanism is the backbone of GST and one of the most fundamental reasons for its implementation.</p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">INPUT TAX CREDIT</p>
                    <!-- <h2 class="heading-title">The ITC is a device that prevents taxes from cascading. In layman's terms, 'tax on tax' describes the cascading of taxes</h2> -->
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="block-left">
                                <p class="paragraph">Credit for taxes levied by the central government is not available as a set-off for taxes levied by state governments, and vice versa, under the current taxation structure. One of the most crucial aspects of the GST system is that it would apply GST throughout the entire supply chain, which will be levied by both the federal and state governments at the same time. Because the tax levied by the federal and state governments would be part of the same tax scheme, tax credit would be available.
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p>One of the fundamental elements of the Goods and Services Tax is the uninterrupted and seamless chain of input tax credit (hereafter referred to as "ITC"). The ITC is a device that prevents taxes from cascading. In layman's terms, 'tax on tax' describes the cascading of taxes.</p>
