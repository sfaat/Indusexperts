...
<section class="page-title page-title-1" id="page-title">
    <div class="page-title-wrap bg-overlay bg-overlay-dark-2">
        <div class="bg-section"><img src="assets/images/page-titles/Secetarial-Compliances.jpg" alt="Background" /></div>
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">FORM DPT-3, FORM INC-20A, INC 22A, MSME FORM </h1>
                        <p class="title-desc">Every Director of the Company in First Meeting of the Board of Director in each Financial Year shall disclose his interest in other entities. <br>Every Director is required to submit with the Company a fresh MBP-1, whenever there is change in his interest from the earlier given MBP-1.
                        </p>
                        <div class="title-action"> <a class="btn btn--primary" href="#"> <span>our services</span><i class="energia-arrow-right"></i></a><a class="btn-video btn-video-2 popup-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4"> <i class="fas fa-play"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-7">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">ANNUAL COMPLIANCES</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph"> <b>Form DIR – 8</b><br>Every Director of the Company in each Financial Year will file with the Company disclosure of non-disqualification..</p>
                                <p class="paragraph"> <b>E-form: MGT-7</b><br>Annual Return: Every Company will file its Annual Return within 60 days of holding of Annual General Meeting. Annual Return will be for the period 1st April to 31st March</p>
                                <p class="paragraph"> <b>E-form: AOC-4</b><br>Financial Statement: Company is required to file its Balance Sheet along with Statement of Profit and Loss Account, Cash flow statement, Directors’ Report and Auditors’ Report in this form within 30 days of holding of Annual General Meeting.</p>
                                <p class="paragraph"> <b>E-form DPT-3</b><br>Return of Deposit: Company is required to file this form every year on or before 30th June in respect of return of Deposit and Particulars not considered as Deposit as on 31st March..</p>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p class="paragraph"><b>BEN-2</b><br>Disclosure of Significant Beneficial Owner: Company shall file BEN-2 within 30 days of receipt of BEN-1 from Share holder. Note: On regular basis company have to check whether there is any SBO in company due to change in its shareholding or due to change in shareholding of body corporate members. </p>
                                    <p class="paragraph"> <b>DIR-3 KYC</b><br>KYC of Directors: All the Directors of company shall file this form on or before 30th September every year for all the directors of the Company..</p>
                                    <p class="paragraph"> <b>MSME-1</b><br>Delay in Payment to MSME Vendor: Company have to file this return half yearly in respect of pending payments to MSME vendors as at end of half year. April to Sep – 30th October October to March – 30th April.</p>
...
<section class="features features-1 bg-overlay bg-overlay-theme2" id="features-1">
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <h5 class="heading-title">DPT-3, INC 20A , INC-22A , MSME </h5>
                    <p class="heading-desc"><b>DPT-3</b><br>The DPT–3 form is a statement return that must be filed by every company that has accepted deposits under section 73 of the Companies Act, 2013 ('Act') and rules issued thereunder, except a Government Firm and a kind of company specified. In general, any money received from the public (including members) is considered a public deposit. Please keep in mind that DPT-3 is a deposit return or a transaction not deemed a deposit, or both, that must be filed by every company except the government. The goal of this form is to provide information regarding the loan or money received by the Company to the Registrar of Companies ('ROC'). </p>

                    <p class="heading-desc"><b>INC 20A</b><br>INC 20A is a declaration of commencement of business that every company must file if the company's date of incorporation falls on or after 2nd Nov 2018. Furthermore, the company must file INC-20A within 180 days of the company's incorporation.
                ...
                <div class="col-12 col-lg-6 offset-lg-1">
                    <p class="heading-desc"><b>INC 22A </b><br>E- Form INC – 22A has been introduced by the MCA for the address validation of all registered companies under the Companies Act, 2013. This form was introduced by the MCA on the 21st of February, 2019.

                    </p>

                    <p>The Micro, Small, and Medium Enterprises Development (MSMED) Act of 2006 was passed by the Indian government, which established MSME or Micro, Small, and Medium Enterprises. These businesses specialise in the manufacture, processing, or preservation of goods and commodities.</p>

                    <p class="heading-desc"><b>MSME  </b><br>MSMEs in India account for roughly 8% of GDP, 45 percent of manufacturing output, and nearly 40% of exports. It's not an exaggeration to call them the country's "backbone."</p>

                    <p class="heading-desc">MSMEs are a vital part of India's economy and have made significant contributions to the country's socioeconomic growth. It not only creates jobs, but it also helps to develop the country's underdeveloped and rural areas. There are approximately 6,08,41,245 MSMEs in India, according to the government's annual report (2018-19).</p>
