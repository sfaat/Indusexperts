                    ...
                    <div class="slide-content">
                        <div class="row">
                            <div class="col-12 col-lg-7">
                                <h1 class="slide-headline">TDS COMPLIANCES </h1>
                                <p  class="text-white" style="font-size: 19px; font-weight: 10px;">The abbreviation TDS stands for Tax Deduction At Source. It indicates that when an individual/organization/person makes a specific payment to another person as defined by the Income Tax Act of 1961, that person (who is making the payment) must deduct TDS if the payment amount exceeds the threshold limit. The Income Tax Act of 1961 contains such rates and threshold restrictions</p>
                                <!-- <ul class="slide-list advantages-list advantages-list-white">
                                    <li>TDS, or Tax Deducted at Source, </li>
                                    <li>Is the amount of income tax deducted from money received at the time of making certain payments.</li>
                                    <li>such as rent, commission, professional fees, salary, interest, and so on.</li>
                                </ul> -->
                ...
                <div class="panels-container">
                    <div class="panel-action">
                        ...
                        <div class="panel-content">
                            ...
                            <p class="panel-desc">Is the amount of income tax deducted from money received at the time of making certain payments.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="about-block">
                    <div class="block-left">
                        <p class="paragraph">TDS, or Tax Deducted at Source, is the amount of income tax deducted from money received at the time of making certain payments, such as rent, commission, professional fees, salary, interest, and so on. In most cases, the person who receives money is responsible for paying income tax. However, the government ensures that income tax is taken in advance from your payments by using Tax Deducted at Source regulations. The net amount is given to the income recipient (after reducing TDS). The gross amount is added to the recipient's income, and the amount of TDS is deducted from his ultimate tax liability. The sum already deducted and paid on his behalf is credited to the beneficiary.</p>
                        <p class="paragraph">For all transactions, TDS is not applicable to all incomes and persons. The Income-tax Act of 1961 established varied TDS rates for different payments and categories of receivers. For example, a debt mutual fund's redemption proceeds are not subject to TDS if paid to a resident individual, but they are subject to TDS if paid to a non-resident Indian.</p>
                        <p class="paragraph">TDS is based on the idea that anyone making certain types of payments to anyone else must deduct tax at source at the rates set out in the Income Tax Act and deposit it into the government's account</p>
            ...
            <div class="col-12 col-lg-5 offset-lg-1">
                <div class="about-img">
                    <div class="about-img-holder bg-overlay">
                        <div class="bg-section"><img src="assets/images/about/TDS.jpg" alt="about Image" /></div>
                    </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 offset-lg-3">
                    <h1 style="color: green;">
                        TCS </h1>
                    <h2 class="heading-title" style="font-size: 23px;">TCS (Tax Collected at Source) is a tax that a seller must pay and collects from the buyer at the moment of sale. The list of items on which the seller must collect tax from buyers is listed in Section 206 of the Income Tax Act.</h2>
                </div>
        ...
        <!-- <div class="carousel owl-carousel carousel-dots" data-slide="3" data-slide-rs="1" data-autoplay="true" data-nav="false" data-dots="true" data-space="30" data-loop="true" data-speed="800">
            <div>
                <div class="service-panel services-panel-3">
                    ...
                    <div class="service-content">
                        <h4><a href="services-turbines.html">solar panels</a></h4>
                        <p>The great thing about solar panels is that they do not require a lot of maintenance. However, still important to get them checked regularly</p><a class="btn btn--secondary" href="services-turbines.html">read more <i class="energia-arrow-right"></i></a>
                    </div>
                </div>
            ...
            <div>
                <div class="service-panel services-panel-3">
                    ...
                    <div class="service-content">
                        <h4><a href="services-turbines.html">wind turbines</a></h4>
                        <p>Wind turbine is an expensive machine, we know very well how important it is that your wind turbine is always up whenever there is wind.</p><a class="btn btn--secondary" href="services-turbines.html">read more <i class="energia-arrow-right"></i></a>
                    </div>
                </div>
            ...
            <div>
                <div class="service-panel services-panel-3">
                    <div class="service-img"> <img src="assets/images/services/3.jpg" alt="image" /></div>
                    <div class="service-content">
                        <h4><a href="services-turbines.html">hydropower plants</a></h4>
                        <p>Hydropower systems are capital intensive assets can produce a significant income provided operated and maintained on high standard.</p><a class="btn btn--secondary" href="services-turbines.html">read more <i class="energia-arrow-right"></i></a>
                    </div>
                </div>
