        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">WRITS UNDER CONSTITUTION IN INDIA</h1>
                        <p class="title-desc">Several powers have been entrusted to the Supreme Court and the High Courts, which they use to administer justice to the people. The authority to issue writs is one of the most important tools or powers that the courts have been given by the constitution </p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">WRITS UNDER CONSTITUTION IN INDIA</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="block-left">
                                <p class="paragraph">A Writ is a command issued by the Court to another person or authority, requiring that person or authority to act or refrain from acting in a specific manner. As a result, writs are an important aspect of the Courts' judicial power.</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-12">
        ...
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    ...
                    <p class="heading-desc"> <b>HABEAS CORPUS </b><br>A trademark protects signs, symbols, logos, words, or sounds that distinguish between the products and services from the competitors. In India, trademark registration allows a trademark owner to use symbols or words to symbolize a company or the products it sells. Once a trademark is registered, no one else can use it for as long as it is in use.</p>
                    <p class="heading-desc">Courts grant Writs of Habeas Corpus in circumstances where a person has been wrongfully detained. Habeas Corpus is a legal term that means "to have the body," and it is one of the most powerful defences a detainee can use.</p>

                    <p class="heading-desc"> <b>MANDAMUS</b><br>The name Mandamus is derived from a Latin word that means "We command." It's a directive from the Supreme Court or the High Court to the</p>
                    <ul class="list-unstyled advantages-list">
                        <li class="text-white">lower or subordinate courts.</li>
                        <li class="text-white">Tribunal.</li>
                        <li class="text-white">Governmental authority.</li>
                    </ul>
                    <p class="heading-desc">To fulfil a governmental or statutory obligation, this writ of command is usually issued when a government, court, company, or public entity fails to perform its duties.</p>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <p class="heading-desc"> <b>CERTIORARI</b><br>The word 'certiorari' means 'to certify.' Certiorari is a writ of pardon. When the Court believes that a lower court or tribunal has acted beyond of its authority or made a legal error, it might use the writ of certiorari to transfer the case to itself or to quash the order made by the lower court or tribunal. The Supreme Court or the High Court may issue a writ of certiorari to a lower court or tribunal in the following circumstances:</p>

                    <ul class="list-unstyled advantages-list">
                        <li class="text-white">or when a subordinate court acts in excess of its jurisdiction by overstepping or crossing jurisdictional boundaries, </li>
                        <li class="text-white">When a subordinate court acts in flagrant violation of the law or procedural procedures</li>
                        <li class="text-white">When a subordinate court acts in violation of principles of natural justice where there is no procedure specified</li>
                    </ul>

                    <p class="heading-desc"> <b>PROHIBITION STAY ORDER:</b><br>The writ of prohibition is issued by Supreme or High Court to a subordinate or inferior courts to forbid or to stop the order passed by them. Both the writ certiorari and prohibition were issued mostly on similar grounds. The main difference between these two writs are: -</p>

                    <ul class="list-unstyled advantages-list">
                        <li class="text-white"><i>Certiorari writs were issued to quash a decision or order after completion of proceedings. And the;</i></li>
                        <li class="text-white"><i>Writ of Prohibition issued before the completion of proceedings.</i></li>
                    </ul>
