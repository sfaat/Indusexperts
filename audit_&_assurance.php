...
<section class="slider slider-3" id="slider-3">
    <div class="container-fluid pe-0 ps-0">
        <div class="slider-carousel owl-carousel carousel-navs carousel-dots" data-slide="1" data-slide-rs="1" data-autoplay="true" data-nav="true" data-dots="true" data-space="0" data-loop="true" data-speed="800">
                    ...
                    <div class="slide-content">
                        <div class="row">
                            <div class="col-12 col-lg-7">
                                <h1 class="slide-headline">AUDIT & ASSURANCE</h1>
                                <p class="text-white" style="font-size: 19px; font-weight: 10px;">We specialise in providing extremely effective and dependable Audit and Assurance services. These services are offered by highly skilled specialists who use cutting-edge auditing methodologies. These services are tailored to international best practises as well as Indian legal requirements.</p>
                                <!-- <ul class="slide-list advantages-list advantages-list-white">
                                    <li>The Company conducts various sorts of audits, as listed below.</li>
                                    <li>Audit of statutory records - Records required by the Companies Act and other statutes are audited.</li>
                                    <li>Investigative auditing entails conducting a targeted investigation.</li>
                                </ul> -->
            ...
            <!-- <div class="slide bg-overlay bg-overlay-dark-slider">
<div class="bg-section"><img src="assets/images/sliders/6.jpg" alt="Background" /></div>
<div class="container">
<div class="slide-content">
<div class="row">
<div class="col-12 col-lg-7">
<h1 class="slide-headline">we invest in the future of planet</h1>
<ul class="slide-list advantages-list advantages-list-white">
<li>Professional on-site and support for certification.</li>
<li>Regular light source for stable conversion efficiency.</li>
<li>Lowest LID by periodic monitoring &amp; superior wafer.</li>
</ul>
<div class="slide-action"><a class="btn btn--white" href="page-services.html"><span>our services</span><i class="energia-arrow-right"></i></a><a class="btn-video btn-video-2 popup-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4"> <i class="fas fa-play"></i><span>our video!</span></a></div>
</div>
        ...
        <div class="row no-gutters">
            <div class="col-12 col-lg-3">
                <div class="data">
                    ...
                    <div class="data-body">
                        <h6>quick contact </h6>
                        <p>email: <a href="../cdn-cgi/l/email-protection.html#7d14131b123d1813180f1a141c531e1210"><span class="__cf_email__" data-cfemail="f49d9a929bb4919a9186939d95da979b99">info@indusexperts.com</span></a></p>
                        <p>phone: <a href="tel:01061245741">(002) 01061245741</a></p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-lg-3">
                <div class="data">
                    ...
                    <div class="data-body">
                        <h6>our location</h6>
                        <p>148 & 149, Tower - B, iThum Building, Sector - 62, Noida (201301), India</p>
                    </div>
                </div>
            </div>
                ...
                <div class="panels-container">
                    <div class="panel-action">
                        ...
                        <div class="panel-content">
                            <h6 class="panel-heading">These auditing services are reasonably priced.</h6>
                            <p class="panel-desc">Statutory audits, concurrent audits, information system audits, investigative audits, compliance audits, and customised audits are among the services we offer</p>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="about about-3 py-3 my-3" id="about-3">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6">
                <div class="heading heading-12">
                    <p class="heading-subtitle">AUDIT & ASSURANCE</p>
                    <!-- <h2 class="heading-title">These services are tailored to best practises as well as Indian legal requirements. </h2> -->
                </div>
                <div class="about-block">
                    <div class="block-left">
                        <p class="paragraph">Audit is a procedure of closely monitoring the accounting information provided in a company's financial statements. Assurance, on the other hand, involves assessing and analysing different operations, processes, and procedures.</p>
                        
                        <p class="paragraph">Statutory audits, concurrent audits, information system audits, investigative audits, compliance audits, and customised audits are among the services we offer. These auditing services are reasonably priced.</p>
                        <p class="paragraph">The Company  conducts various sorts of audits, as listed below.</p>
                        <p class="paragraph">Compliance Accounting Standards Audit - To guarantee that all applicable accounting standards are followed by the organisation.</p>
                        <p class="paragraph">Investigative auditing entails conducting a targeted investigation.</p>
                        <p class="paragraph">Internal control measures are being implemented, and compliance is being monitored.</p>
            ...
            <div class="col-12 col-lg-5 offset-lg-1">
                <div class="about-img">
                    <div class="about-img-holder bg-overlay">
                        <div class="bg-section"><img src="assets/images/about/being-audited-by-the-irs-for-your-income-taxes-ta-2022-01-18-19-13-38-utc.jpg" alt="about Image" /></div>
                    </div>
...
<section class="services services-3 bg-overlay bg-overlay-white2 py-3 my-3" id="services-3">
