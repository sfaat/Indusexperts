        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">GST ADVISORY AND TRANSCATION STRUCTURING </h1>
                        <p class="title-desc">Our ambit extends to advisory services for prudent structuring of business transactions to ensure correct tax structures and cost efficiencies.</p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">GST ADVISORY AND TRANSCATION STRUCTURING </p>
                    <!-- <h2 class="heading-title">Changes in the norms governing the provision of products and services, or both including analysing the impact of GST on our customers' businesses</h2> -->
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="block-left">
                                <p class="paragraph">Our GST advising services include: determining the impact of GST on business and product pricing by analysing important characteristics such as: Rates of taxation have changed. Changes in the norms governing the provision of products and services, or both including analysing the impact of GST on our customers' businesses, researching various market scenarios for business models, legislative business level implementation help, transition management, and key compliance.</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p>Our ambit extends to advisory services for prudent structuring of business transactions to ensure correct tax structures and cost efficiencies.</p>
