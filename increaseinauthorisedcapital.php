        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">INCREASE IN AUTHORISED CAPITAL</h1>
                        <p class="title-desc">An increase in authorised share capital would include the overall adding of more capital to the company. There is a formal process and procedure to carry out the Increase in Authorised Share Capital. </p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-7">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">INCREASE IN AUTHORISED CAPITAL</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">The increase of Authorised Share capital is governed by the provisions of the Companies Act, 2013. Based on the amount of share capital of the company, the business can expand as per these requirements.</p>

                                <p class="paragraph">Convene an Extraordinary General Meeting (EGM)
                                    Alter the Memorandum of Association</p>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p class="text-dark"><b>Benefits </b></p>
...
<section class="features features-1 bg-overlay bg-overlay-theme2" id="features-1">
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <h2 class="heading-title">Procedure for Increase in Authorised Share Capital</h2>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <p class="heading-desc">There is a proper procedure for increase in authorised share capital. Such procedure has to be compliant with the relevant provisions of the Companies Act, 2013. The following procedure has to be utilised for increase in authorised share capital:.</p>
                    <p class="heading-desc">Articles of Association (AOA) must have governing norms for authorisation
                        Board Meeting.</p>
