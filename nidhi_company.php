        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">NIDHI COMPANY</h1>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">NIDHI COMPANY</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12" style="text-align: justify">
                            <div class="block-left">
                                <p class="paragraph">The Indian government created this type of corporate structure with the primary goal of supplying funds. This entity is used by individuals to lend money to the general population. Nidhi businesses are primarily found in India's southern states.
                                    Any type of business that engages in operations related to a Nidhi corporation must adhere to the registration procedure' standards. Section 406 of the Companies Act 2013 lays forth the steps for forming a Nidhi company.

                                </p>
                                <p class="paragraph">When it comes to the development of savings and various forms of mutual benefits, creating this type of company has numerous advantages. Apart from that, the company's members are aware of their financial wants and requirements to entice foreign equity and loan participation</p>
                                <p class="paragraph">The Indian government created this type of corporate structure with the primary goal of supplying funds. This entity is used by individuals to lend money to the general population. Nidhi businesses are primarily found in India's southern states.
                                    The Nidhi Entity provisions are found in Chapter 26 of the Companies Act, 2013. The definition of a Nidhi corporation can be found in section 406 of the Companies Act, 2013. A Mutual Benefit Society is another name for this type of organisation. If there is a specific notification, an entity can be categorised as a mutual benefit society under section 406(1).</p>
...
<section class="about about-1" id="about-1" style="padding: 5px;">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-7" style="padding: 25px;">
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-12" style="text-align: justify">
                            <div class="block-left">
                            ...
                            <div class="block-right">
                                <div class="prief-set">
                                    <ul class="list-unstyled advantages-list">
                                        <li class="text-dark">Easy to Lending</li>
                                        <li class="text-dark">Easy to form Management</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    ...
                                    <ul class="list-unstyled advantages-list">
                                        <li class="text-dark">Minimum 7 members required to start a Nidhi Company out of which 3 members must be the directors of the company .</li>
                                        <li class="text-dark">Minimum Capital of Rs 5 Lakh required to start Nidhi Company.</li>
                                        <li class="text-dark">Nidhi Company should have minimum 200 members within one year from commencement.</li>
                                        <li class="text-dark">Also, the net owned funds should be 10 lakh rupees or more</li>
                                        <li class="text-dark">Unencumbered term deposits must be 10% or higher of the outstanding deposits.</li>
                                        <li class="text-dark">The ratio of net owned funds to deposits shouldn’t be more than 1:20</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="container">
                <div class="col-lg-12">
                    <div class="card">
                    <div class="card-body">
                    <h5 >PROCEDURE TO REGISTER NIDHI COMPANY</h5>
                    <ul class="list-unstyled advantages-list">
                        <li>Filing of form INC9 by all the subscribers to the Memorandum of Association (MOA)</li>
                        <li>Filing of form DIR-2 by all the Directors of the company. Declaration as per Rule 5 and 6 of Nidhi Rules 2014 has to be signed by all the subscribers.</li>
                        <li>The Conflict of Interest (COI) has to be filed by the applicant. This has to be filed in form INC- 7, INC- 22, and DIR- 12.</li>
                    </ul>
                    </div>
                    </div>
