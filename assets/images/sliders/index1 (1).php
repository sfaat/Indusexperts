                    ...
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="slide-content">
                                <h1 class="slide-headline">GST ADVISORY AND TRANSCATION STRUCTURING</h1>
                                <p class="slide-desc">Our ambit extends to advisory services for prudent structuring of business transactions to ensure correct tax structures and cost efficiencies.</p>
                                <div class="slide-action">
                                    ...
                                    </div><a class="btn btn--primary" href="gst advisory_&_transcation_structuring.php"> <span>our services</span><i class="energia-arrow-right"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-lg-3 offset-lg-2 d-flex">
                            <div class="slider-panel-holder">
                                <div class="slider-panel"><i class="panel-icon flaticon-028-greenhouse"></i>
                                    ...
                                    <p class="panel-desc">To upload highest standards of integrity, commitment and confidentiality and to always works towards improving the quality of services.</p><a href="#"><i class="energia-arrow-right"> </i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="slide bg-overlay bg-overlay-dark-slider">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="slide-content">
                                <h1 class="slide-headline">LIMITED LIABILITY PARTNERSHIP</h1>
                                <p class="slide-desc">The word LLP stands for Limited Liability Partnership.  LLP is a unique type of business organisation that combines the characteristics of a typical partnership with the benefits of limited liability for its partners.</p>
                                <div class="slide-action">
                                    <div class="slide-list">
                                        <div class="icon"> <i class="flaticon-040-green-energy"></i></div>
                                        <div class="icon"> <i class="flaticon-020-factory"></i></div>
                                        <div class="icon"> <i class="flaticon-031-nuclear-plant"></i></div>
                                    </div><a class="btn btn--primary" href="limited_liability_partnership.php"> <span>our services</span><i class="energia-arrow-right"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-lg-3 offset-lg-2 d-flex">
                            <div class="slider-panel-holder">
                                <div class="slider-panel"><i class="panel-icon flaticon-019-electric-tower"></i>
                                    ...
                                    <p class="panel-desc">To be recognized for delivering the best integral advisory services to our clients with effective results.</p><a href="#"><i class="energia-arrow-right"> </i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-7">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">Company Setup of Startup Registration</p>
                    <h2 class="heading-title">What Is A Company Registration?</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">1. The very first step for Section 8 company registration is to prepare DSC. Apply for Digital Signature Certificate (DSC) as soon as possible.

                                </p>
                                <p class="paragraph">2. After Name approval, we will apply for Section 8 company registration license from Regional director.The regional director will review the objectives, plans and will grant a permit for Section 8 Company registration. RD usually takes 15 days to issue a license to operate as a section 8 Company..</p><a class="btn btn--secondary" href="company_registration.php">read more <i class="energia-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p class="text-dark"><b>Types of Companies in India.</b></p>
                                    <ul class="list-unstyled advantages-list">
                                        <li class="text-dark">Private Limited Company</li>
                                        <li class="text-dark">One Person Company</li>
                                        <li class="text-dark">Producer Company</li>
                                        <li class="text-dark">Nidhi Company</li>
                                        <li class="text-dark">Startup Registration</li>
                                        <li class="text-dark">solar material financing</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Law of India does not permit the solicitation of work and advertising by practitioners and advocates. By accessing the indus expert (our website), the user acknowledges that there has been no attempt by us to advertise or solicit work, it just for informational purposes only. If any information obtained by us through this website is not meant that its advice provide by us and there is no arise any client-attorney relation.    Non of the information contained in our website amounts to form of legal opinion of legal advice. Our website uses cookies to improve your user experience. By using our site, you agree to our use of cookies and prepared Coockies Policy and Privacy policy as well.</p>
...
<section class="features features-1 bg-overlay bg-overlay-theme2" id="features-1">
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <p class="heading-subtitle">DIRECT TAX ADVISORY</p>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-lg-5">
                    <h2 class="heading-title">These Services Are Tailored To Best Practises As Well As Indian Legal Requirements.</h2>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <p class="heading-desc">Investors are increasingly excited about investing in India as the country's ease of doing business improves. At every stage of the business lifecycle, our team of experts advises businesses on numerous tax and regulatory issues, allowing them to explore and capitalise on opportunities.</p>
                    <p class="heading-desc">Investors are increasingly excited about investing in India as the country's ease of doing business improves. At every stage of the business lifecycle, our team of experts advises businesses on numerous tax and regulatory issues, allowing them to explore and capitalise on opportunities.</p>
                    <div class="actions-holder"><a class="btn btn--primary btn--inversed" href="direct_tax_advisory.php">
            ...
            <div>
                <div class="feature-panel-holder" data-hover="">
                    <div class="feature-panel">
                        ...
                        </div><a href="page-about.php"><i class="energia-arrow-right"></i> <span>explore more</span> </a>
                    </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-4">
                <!-- <div class="more-features">
                    <p>If you have any questions or need help, feel free to contact with our team, or you can call us any time <a href="tel:01061245741">(002) 01061245741</a></p><a class="btn btn--bordered btn--white" href="page-about.php">
...
<!-- <section class="services services-1 bg-grey" id="services-1">
    <div class="container">
        ...
        <div class="carousel owl-carousel carousel-dots dots-side" data-slide="3" data-slide-rs="1" data-autoplay="true" data-nav="false" data-dots="true" data-space="30" data-loop="true" data-speed="800">
            <div>
                <div class="service-panel">
                    ...
                    <div class="service-content">
                        <h4><a href="services-turbines.php">solar panels<br />services</a></h4>
                        ...
                        </ul><a class="btn btn--secondary" href="services-turbines.php">read more <i class="energia-arrow-right"></i></a>
                    </div>
                </div>
            ...
            <div>
                <div class="service-panel">
                    ...
                    <div class="service-content">
                        <h4><a href="services-turbines.php">wind turbines<br />services</a></h4>
            ...
            <div>
                <div class="service-panel">
                    ...
                    <div class="service-content">
                        <h4><a href="services-turbines.php">hydropower plants<br />services</a></h4>
        ...
        <div class="more-services">
            <p>Sustainable, reliable & affordable energy systems, <a href="#">Find Your Solution Now! </a></p>
        </div>
...
<section class="counters counters-1 bg-overlay bg-overlay-theme2" id="counters-1">
    ...
    <div class="container">
        <div class="heading heading-4 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <h2 class="heading-title">GST ADVISORY AND TRANSCATION STRUCTURING</h2>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <p class="heading-desc">Our GST advising services include: determining the impact of GST on business and product pricing by analysing important characteristics such as: Rates of taxation have changed. Changes in the norms governing the provision of products and services, or both including analysing the impact of GST on our customers' businesses, researching various market scenarios for business models, legislative business level implementation help, transition management, and key compliance.</p>
                    <div class="actions-holder"><a class="btn btn--primary btn--inversed" href="gst advisory_&_transcation_structuring.php">
                            <i class="energia-arrow-right"></i></a></div>
                </div>
            </div>
...
<!-- <section class="testimonial testimonial-1 bg-theme2">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="carousel owl-carousel carousel-nav carousel-dots" data-slide="2" data-slide-rs="1" data-autoplay="true" data-nav="true" data-dots="true" data-space="40" data-loop="true" data-speed="800">
            ...
            <div class="col-12">
                <div class="carousel owl-carousel carousel-dots" data-slide="3" data-slide-rs="1" data-autoplay="true" data-nav="false" data-dots="true" data-space="30" data-loop="true" data-speed="3000">
                    <div>
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                <div class="project-img"><a class="link" href="projects-single.php"></a><img src="assets/images/projects/modern/1.jpg" alt="project image" /></div>

                                <div class="project-content">
                                    <div class="project-cat"><a href="projects-standard.php">finance</a><a href="projects-standard.php">supply chain</a>
                                    </div>
                                    <div class="project-title">
                                        <h4><a href="projects-single.php">expanding The Solar Supply Chain Finance Program</a></h4>
                                    </div>
                                    ...
                                    <div class="project-more"> <a class="btn btn--bordered btn--white" href="projects-single.php">explore more <i class="energia-arrow-right"></i></a></div>
                                </div>
                    ...
                    <div>
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                <div class="project-img"><a class="link" href="projects-single.php"></a><img src="assets/images/projects/modern/2.jpg" alt="project image" /></div>

                                <div class="project-content">
                                    <div class="project-cat"><a href="projects-standard.php">energy</a><a href="projects-standard.php">green energy</a>
                                    </div>
                                    <div class="project-title">
                                        <h4><a href="projects-single.php">Addressing Wind Energy Innovation Challenges</a></h4>
                                    </div>
                                    <div class="project-desc">
                    ...
                    <div>
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                <div class="project-img"><a class="link" href="projects-single.php"></a><img src="assets/images/projects/modern/3.jpg" alt="project image" /></div>

                                <div class="project-content">
                                    <div class="project-cat"><a href="projects-standard.php">eco</a><a href="projects-standard.php">green energy</a>
                                    </div>
                                    <div class="project-title">
                                        <h4><a href="projects-single.php">Smarter Ways to Manage EV Charging Infrastructures</a></h4>
                                    </div>
                                    <div class="project-desc">
                    ...
                    <div>
                        <div class="project-panel" data-hover="">
                            <div class="project-panel-holder">
                                <div class="project-img"><a class="link" href="projects-single.php"></a><img src="assets/images/projects/modern/4.jpg" alt="project image" /></div>

                                <div class="project-content">
                                    <div class="project-cat"><a href="projects-standard.php">eco</a><a href="projects-standard.php">green energy</a>
                                    </div>
                                    <div class="project-title">
                                        <h4><a href="projects-single.php">New Public Attitude Tracker Towards Renewable Energy</a></h4>
                                    </div>
                                    <div class="project-desc">
    ...
    <div class="container">
        <div class="contact-panel contact-panel-3">
            <div class="heading heading-light heading-6">
                ...
                <div class="contact-action"><a class="btn btn--white" href="page-about.php">learn more <i class="energia-arrow-right"></i></a><a class="btn btn--bordered btn--white" href="page-faqs.php">our core values</a></div>
...
$(document).ready(function() {
    if(sessionStorage.getItem('#exampleModalS')!=='true')
	{
		$('#exampleModalS').modal('show');
		sessionStorage.setItem('#exampleModalS',true);
	}
});
