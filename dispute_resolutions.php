        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">ALTERNATE DISPUTE RESOLUTION</h1>
                        <p class="title-desc">Dispute Resolution or you can say alternative dispute resolution, appropriate dispute resolution or ADR refer to a number of processes used to resolve a dispute between parties. </p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">ALTERNATE DISPUTE RESOLUTION</p>
                    <h2 class="heading-title">ADR is usually an alternative to litigation and can be used to resolve dispute.</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">Dispute Resolution or you can say alternative dispute resolution, appropriate dispute resolution or ADR refer to a number of processes used to resolve a dispute between parties. ADR is usually an alternative to litigation and can be used to resolve any type of dispute including family, corporate, commercial, employment related, business, housing, personal injury, securities, consumer, environmental dispute, and any other disputes.</p><a class="btn btn--secondary" href="#">read more <i class="energia-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p>Our Practices help our clients to manage their businesses more successfully by providing strategic risk management advice and managing risk from the start. We serve a wide range of industries in both representational and advisory legal services, advising individuals and businesses on all areas of their disputes.</p>
...
<section class="features features-1 bg-overlay bg-overlay-theme2" id="features-1">
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <h2 class="heading-title">DIFFERENT TYPES OF DISPUTES RESOLUTION METHODS</h2>
                    <p class="heading-desc"> <b>NEGOTIATION</b><br> Negotiation is the least formal form of alternative dispute resolution. The purpose of negotiation is to assist parties in reaching an agreement on their own. Parties can enlist the support of a neutral third party to assist them in reaching an agreement. The outcome of the discussion is rarely binding; nonetheless, parties can move to court to resolve their issue and get an enforceable judgement</p>
                </div>
                <div class="col-12 col-lg-12 offset-lg-1">

                    

                    <p class="heading-desc"> <b>MEDIATION</b><br> Mediation is a process in which disputants are assisted in resolving their differences by a neutral third party (typically a professional mediator). Mediation is less formal than arbitration but more formal than negotiation. Although the outcome of mediation is not binding, parties can still go to court to resolve their issue and obtain an enforceable decision after the mediation is over</p>
                    <p class="heading-desc"> <b>ARBITRATION</b><br>Arbitration is one of the more formal forms of ADR; despite being less formal than a traditional trial, arbitration is usually conducted by professional arbitrators (one or a panel) who operate as 'judges,' and parties must adhere to the norms set forth in their arbitration agreement. Unless the court finds a violation of the arbitration agreement, the arbitrator's decision is usually final.</p>
