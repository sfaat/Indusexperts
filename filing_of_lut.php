        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">FILING OF LUT </h1>
                        <p class="title-desc">Letter of Undertaking. It is prescribed to be furnished in the form GST RFD 11 under rule 96 A, whereby the exporter declares that he or she will fulfill all the requirement that is prescribed under GST while exporting without making IGST payment. </p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">FILING OF LUT</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="block-left">
                                <p class="paragraph">GST LUT is to be submitted by all GST registered goods and service exporters. The exporters who have been prosecuted for any offense and the tax evasions exceeding Rs 250 lakhs under CGST Act 2017 or the Integrated Goods and Service Act, 2017 or any existing laws are not eligible to file the GST LUT. In such cases, they would have to furnish an Export bond.</p>
                                

                                <p class="paragraph">The validity of such LUT's is for one year, and an exporter is required to furnish a fresh LUT for each financial year. If the conditions mentioned in the LUTs are not satisfied within the specified time limit, then the privileges will be revoked, and the exporter will have to furnish bonds.</p>
                                <p class="paragraph">Here the motive of the government was to expand the export base by providing reliefs on exports.</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p class="paragraph">Under CGST Rules,2017, any registered person can furnish an Export bond or LUT in GST RFD 11 without paying the integrated tax. They can apply for LUT if:</p>
                                    <ul class="list-unstyled advantages-list">
                                        <li>They intend to supply goods or services to India or overseas or SEZs </li>
                                        <li>Are registered under GST </li>
                                        <li>They wish to supply goods without paying the integrated tax.</li>
