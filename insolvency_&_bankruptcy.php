        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">INSOLVENCY AND BANKRUPTCY</h1>
                        <p class="title-desc">The insolvency and Bankruptcy Code of 2016, which came into effect in 2016, insolvency & Bankruptcy is an important aspect of our range of services.</p>
...
<section class="about about-1 my-3 py-3" id="about-1">
    <div class="container">
        <div class="row">
            <!-- <div class="col-12 col-lg-5">
                <div class="about-img">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">INSOLVANCY AND BANKRUPTCY</p>
                    <h2 class="heading-title">ENSURING ECONOMIC RECOVERY THROUGH PPIRP AND CIRP</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph" style="text-align: justify;">The insolvency and Bankruptcy Code of 2016, which came into effect in 2016, Insolvency & Bankruptcy is an important aspect of our range of services. Our staff is critical in providing suitable support for corporate and individual insolvency and bankruptcy procedures, as well as providing sustenance for creditors and debtors amid difficult debt recovery in a variety of industries. Bankruptcy is a legal process that provides protection and relief for individuals who are unable to pay off their debts. When you file for bankruptcy, a Licensed Insolvency Trustee will be assigned to liquidate your assets, contact your creditors, and investigate your affairs. You will also have to comply with bankruptcy duties including attending credit counseling sessions..</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p style="text-align: justify;">insolvency refers to a situation in which a company or individual is unable to pay their obligations. and debts. It can lead to insolvency procedures, in which the insolvent individual or company faces legal action and assets are liquidated to pay off outstanding debts. Creditors can be contacted directly by business owners to restructure debts into more affordable instalments. Creditors are usually sympathetic to this strategy because they want to be paid, even if it's on a delayed basis.</p>
...
<section class="features features-1 bg-overlay bg-overlay-theme2" id="features-1">
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <h2 class="heading-title">WHAT IS BANKRUPTCY?</h2>
                    <p class="heading-desc">A bankruptcy, on the other hand, is a formal court order that outlines how an insolvent person or business will repay their creditors or sell their assets to make the payments. Even if it's merely a temporary issue, a person or organisation can be insolvent without going bankrupt. If the condition lasts longer than expected, it may result in bankruptcy.</p>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
              
                    <p class="heading-desc">Bankruptcy is a legal process that gives those who are unable to pay their debts protection and relief. A Licensed Insolvency Trustee will be assigned to liquidate your assets, contact your creditors, and examine your affairs once you file for bankruptcy. You'll also have to follow bankruptcy rules, which include going to credit counselling programs.</p>
