        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">GST FILING & COMPLIANCES </h1>
                        <!-- <p class="title-desc">The GST compliance rating is a score given by the government to a business so that other businesses can see how compliant they are with the tax department. </p> -->
                        <p class="title-desc">The CGST Act, 2017, outlines the GST compliance standards, as well as initiatives to reduce the burden on taxpayers and penalties for non-compliance. Foreign investors should also be aware of the Advance Ruling provision, which was implemented to provide tax certainty.</p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">GST FILING & COMPLIANCES</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            ...
                            <div class="block-left">
                                <p class="paragraph">The GST compliance rating is a score given by the government to a business so that other businesses can see how compliant they are with the tax department. This score will be calculated based on parameters such as timely filing of monthly and annual returns, furnishing details of input credits used, taxes paid, etc.</p>
                                <p class="paragraph">All registered businesses have to file monthly or quarterly and an annual GST return based on the type of business. All these GSTR filings are done online on the GST portal. </p>
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p class="text-dark">Return filing is mandatory under GST. Even if there is no transaction, you must file a Nil return.</p>
                                    
                                    <p class="text-dark"> A GST return is a document containing details of all income/sales and/or expense/purchase which a taxpayer (every GSTIN) is required to file with the tax administrative authorities. This is used by tax authorities to calculate net tax liability.</p>

                                    <p class="text-dark">In the GST regime, any regular business having more than Rs.5 crore as annual aggregate turnover has to file two monthly returns and one annual return. This amounts to 26 returns in a year.</p>
