        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">PRIVATE LIMITED COMPANY</h1>
        ...
        <div class="row">
            <div class="col-12 col-lg-5">
                <div class="about-img">
                    <div class="about-img-holder bg-overlay">
                        <div class="bg-section"><img src="assets/images/about/Private-company.jpg" alt="about Image" /></div>
                    </div>
                    <div>
            ...
            <div class="col-12 col-lg-7">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">Private Limited Company</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12" style="text-align: justify">
                            <div class="block-left">
                                <p class="paragraph">In India, the most common type of "legal structure" for all businesses is a private limited company.
                                    A private limited business can have two members minimum and fifty members maximum.


                                </p>
                                <p class="paragraph">A private limited company's directors have limited liability to its creditors, and banks/creditors are only allowed to sell the company's assets (when there is a scenario of default).</p>
                                <p class="paragraph">Creditors do not have the authority to sell directors' personal assets. When launching a business in India, make sure your firm is registered.</p>

                                <p class="paragraph"> One of the most common types of legal entities for conducting business is a private limited company. The Ministry of Corporate Affairs regulates private limited companies, which are formed under the Companies Act of 2013. There are two sorts of private limited companies.</p>
                            </div>
            ...
            <div class="col-12 col-lg-12" style="padding: 25px;">
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-12" style="text-align: justify">
                            <div class="block-left">
                                <p class="paragraph">In the recent times, it has been seen that, it has become the most preferred form of business organization among the entrepreneurs.
                                </p>
                                <p class="paragraph" style="font-weight: 600;">
                                    Key Features of a Private Limited Company are as follows:
                                </p>
                                <p class="paragraph">Unlike Sole Proprietorship and Partnership Firms, it enjoys a status of separate legal entity, where even if the members or the management of the company changes or cease to exist due to any reason whatsoever, the company still continues to stay in existence.</p>
                                <p class="paragraph"> A Company can hold the assets of the company in its own name separate from its shareholders.</p>

                                <p class="paragraph"> A member has a limited liability in the company, limited to the amount of shares held in the company / liability undertaken. Members of the Company do not hold any personal liability.</p>
                                <p class="paragraph">Creditworthiness of a company is better than any other form of organization.</p>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    ...
                                    <ul class="list-unstyled advantages-list">
                                        <li class="text-dark">Minimum two directors</li>
                                        <li class="text-dark">Minimum two shareholders</li>
                                        <li class="text-dark">At least one director should be from India</li>
                                        <li class="text-dark">Maximum 200 shareholders.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
