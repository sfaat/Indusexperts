        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">DRAFTING AND VETTING</h1>
                        <p class="title-desc">Drafting and Vetting of Agreements An agreement defines the rights, duties, responsibilities, and obligations of the parties to the agreement and binds them together to achieve common business objectives </p>
                        <div class="title-action"> <a class="btn btn--primary" href="#l"> <span>our services</span><i class="energia-arrow-right"></i></a><a class="btn-video btn-video-2 popup-video" href="https://www.youtube.com/watch?v=nrJtHemSPW4"> <i class="fas fa-play"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">DRAFTING AND VETTING</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">Legal drafting is a method of creating well-structured documents such as petitions, memorandums, bylaws, agreements, deeds, writs, contracts, wills, statutes, etc that are legally binding on the parties to such documents. Such documents in a general sense are known as legal drafts. It is important that the language in which they are written is simple so that the intended audience can read and comprehend it.This article tries to cover the steps of legal drafting, the understanding of how it is essential to draft in easy English and what are the drawbacks or disadvantages if we don’t. </p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p>Also, that there is no room for any interpretation other than literal one by the courts. The entire point of a legal draft is to be crisp, precise, it shouldn’t have a lot of double negatives, and should convey a point in comprehensible language. The best Drafts are those in which concise and unambiguous language is used; unnecessary abbreviations are avoided, “community jargon” and excessively long sentences are also avoided. This article tries to cover the steps of legal drafting.</p>
                                    <ul class="list-unstyled advantages-list">
                                        <li>Lease Agreement-</li>
                                        <li>Late Rent Notice </li>
                                        <li>Vocation Notice</li>
                                        <li>Sale Deed</li>
                                        <li>Mortgage deed </li>
                                        <li>Transfer Deed</li>
                                        <li>Will Drafting and Registration</li>
                                        <li>Gift Deed</li>
                                        <li>Exchange Deed & etc.</li>
...
<section class="features features-1 bg-overlay bg-overlay-theme2" id="features-1">
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <h2 class="heading-title">Legal contract vetting includes a detailed examination of the agreement's contents, as well as assuring the following:</h2>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <p class="heading-desc">All precautions have been taken.</p>
                    <p class="heading-desc">A distinct job has been established.</p>
                    <p class="heading-desc">legal recourse</p>
                    <p class="heading-desc">financial stability</p>
                    <p class="heading-desc">concerns that are well defined</p>
                    <p class="heading-desc">Issues of clarity and monetary terminology</p>
