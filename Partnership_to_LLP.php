        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">PARTNERSHIP TO LLP</h1>
                        <p class="title-desc">A partnership company is one in which two or more persons share ownership of the company. Each partner in a partnership corporation contributes to all parts of the business. The earnings and losses of the business are also shared by the partners. A limited liability partnership (LLP) is a firm in which all partners have limited responsibility. One partner is not liable for the diligence or negligence of the other. </p>
                ...
                <div class="jumbotron">
                    <div class="card p-5 my-2">
                        <div class="card-body" style="font-size: 20px; font-family:Georgia, 'Times New Roman', Times, serif; color: black;">
                            As a result, for those of you who wish to be safe when doing business, converting your Partnership to a Limited Liability Partnership is an excellent option. You'll be combining the partnership component of a firm with the limited liability aspect of a corporation by doing so.
                        </div>
                    </div>

                    <div class="card p-5 my-2">
                        <div class="card-body">
                            <h5>Advantages of LLP</h5>
                            <ul class="list-unstyled advantages-list">
                                <li style="color: black;"> Minimal Compliances</li>
                                <li style="color: black;">Low Setup cost</li>
                                <li style="color: black;">Separate Legal Entity</li>
                                <li style="color: black;">Tax Advantages</li>
                            </ul>
                    ...
                    <div class="card p-5 my-2">
                        <div class="card-body">
                            <h5>Minimum requirements for conversion to LLP</h5>
                            <ul class="list-unstyled advantages-list">
                                <li style="color: black;">Income tax returns must be filed on time.</li>
                                <li style="color: black;">The partners will only be compensated through the distribution of LLP shares.</li>
                                <li style="color: black;">	All unsecured creditors must agree to the planned LLP conversion</li>
                                <li style="color: black;">Two partners are required</li>
                                <li style="color: black;">	At least one of the designated partners must be a resident of India.</li>
                                <li style="color: black;">For all partners, DPIN.</li>
                                <li style="color: black;">For all partners, DSC.</li>
                                <li style="color: black;">Each partner must provide some form of contribution.</li>
                            </ul>
