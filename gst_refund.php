        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">GST REFUND </h1>
                        <p class="title-desc">GST refund is a procedure in which registered taxpayers can recoup an excess amount if they overpaid their GST duty. They can make a claim after filling out a refund application with all of the required information on the GST portal.</p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">GST REFUND </p>
                    <!-- <h2 class="heading-title">RFD-01 is a GST refund application that allows you to submit refunds online.</h2> -->
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="block-left">
                                <p class="paragraph">Under the GST, the term "refund" is particularly significant for both the person who is qualified for a refund and the GST Authority who issues the refund order. Both the person claiming the return and the person issuing the refund should be well-versed in the statutes and laws governing GST refunds.</p>
                                <p class="paragraph">GST refund is a process in which, registered taxpayers can claim excess amount if they paid more than the GST liability. They can claim after submitting a refund application with the necessary details in the GST portal.</p>
                                </p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p>RFD-01 is a GST refund application that allows you to submit refunds online. In the case of zero-rated supplies, it must be e-filed on the GST portal to obtain a refund of: taxes, cess, and interest paid (except the export of goods with tax payment). Excess cash is deposited into the electronic cash ledger.</p>
