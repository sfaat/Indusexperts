...
<section class="page-title page-title-1" id="page-title">
    <div class="page-title-wrap bg-overlay bg-overlay-dark-2">
        <div class="bg-section"><img src="assets/images/page-titles/Legal.jpg" alt="Background" /></div>
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">PROPRIETORSHIP TO PRIVATE LIMITED COMPANY</h1>
                        <p class="title-desc">Many business people start their businesses as a Sole Proprietorship due to the low compliance requirements. As the business and the incomes grow, there is a need to separate the bank accounts and the tax filings of the Sole Proprietor and that of the business. To accomplish this separation a possible solution is to convert the Sole Proprietorship into a Private Limited Company. </p>
...
<section style="background-color: #566573;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="jumbotron">
                    <div class="card p-5 my-2">
                        <div class="card-body" style="font-size: 20px; font-family:Georgia, 'Times New Roman', Times, serif; color: black;">
                    ...
                    <div class="card p-5 my-2">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled advantages-list">
                                <li style="color: black;">The liability of shareholders is limited to their shares. Financial risks are a part of business but to be able to minimize them and sustain the business progress is imperative. In an LTD, if due to any reason the company were to be closed the shareholders would not risk losing their personal assets.</li>
                                <li style="color: black;">Risk of takeovers is minimized when two shareholders trade shares as the selling and buying of shares is possible only when both parties have given their consent.</li>
                                <li style="color: black;">Private limited companies are incorporated; hence it continues to exist even if the owner dies.</li>
                                <li style="color: black;">The capital or options of raising investment in business is not restricted to one person, which is the case in sole proprietorship.</li>

                                <li style="color: black;">-	Private limited companies pay corporate tax on their profits. Dividends that the shareholders receive are not taxed. Taxes are determined as per their personal income tax rate.</li>
                                <li style="color: black;">-	Sole proprietorship has difficulty in reaching large-scale business standards whereas it is not the case in LTD. Private limited companies can attract high-calibre employees that offer great help in the growth of the company.</li>
                                <li style="color: black;">-	The burden of the operations and running of the business falls on one person in sole proprietorship. Whereas, in LTD, the business is much easier to manage.</li>
                    ...
                    <div class="card p-5 my-2">
                        <div class="card-body">
                            <h5>Minimum requirements for conversion  </h5>
                            <ul class="list-unstyled advantages-list">
                                <li style="color: black;">Minimum 2 Directors</li>
                                <li style="color: black;">Minimum 2 Shareholders</li>
                                <li style="color: black;">DIN for all directors</li>
                                <li style="color: black;">-	Minimum Share Capital of Rs 1lakhs</li>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-7">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">Cyber Law</p>
                    <h2 class="heading-title">The Information Technology Act has been passed.</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">The Information Technology Act has been passed to give effect to the UN resolution and to promote efficient delivery of Government services by means of reliable electronic records. As per preamble to the Act, the purpose of Act is (a) to provide legal recognition for transactions carried out by means of electronic data interchange and other means of electronic communication, commonly referred to as "electronic commerce", which involve the use of alternatives to paper-based methods of communication and storage of information and (b) to facilitate electronic filing of documents with the Government agencies.</p><a class="btn btn--secondary" href="#">read more <i class="energia-arrow-right"></i></a>
                            </div>
                        </div>
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p>We provide comprehensive legal Services to our clients to protect from the cybercrimes and remedy, if they are victim of hacking, phishing, and other mode of cybercrimes. We provide various following services to our clients to face complex changes that are inevitable for the smooth functioning of e-commerce and electronic/digital world, namely:</p>
                                    <ul class="list-unstyled advantages-list">
                                        <li>Electronic contracts</li>
                                        <li>digital signatures </li>
                                        <li>Security procedure</li>
                                        <li>Certifying Authorities</li>
                                        <li>digital signature certificates</li>
                                        <li>computer crimes</li>
                                        <li>Adjudicating Officer</li>
                                        <li>Proceeding and enquiry/inquiries</li>
                                        <li>Cyber Appellate Tribunal</li>
                                        <li>Cyber Appellate Tribunal </li>
                                        <li>Appellate Tribunal to High Court</li>
                                        <li>Complaints pertaining </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
