        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">STRIKE OFF</h1>
                        <p class="title-desc">Striking a company's name off the register is an alternate method of ceasing business. For specific situations, the Registrar of Companies ('ROC') can issue a notice to strike the company name from the Register of Companies. The firm can also file a request with the ROC to have its name removed from the Register of Companies.
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-7">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">STRIKE OFF</p>
                    <h2 class="heading-title">PROCEDURE FOR STRIKING OFF COMPANYS NAME</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">Striking a company's name off the register is an alternate method of ceasing business. For specific situations, the Registrar of Companies ('ROC') can issue a notice to strike the company name from the Register of Companies. The firm can also file a request with the ROC to have its name removed from the Register of Companies.</p>

                                <p class="paragraph">A notice issued by the ROC or an application filed by a corporation for the striking off of its name shall be published in the Official Gazette to inform the general public. When the stipulated time in the notification for striking off expires, the ROC will strike the company name from the Register of Companies unless the company presents a compelling justification for the same within the specified time.</p>

                                <p class="paragraph">After striking out the company name from the Register of Companies, the ROC will publish the dissolution notification in the Official Gazette. The corporation will be dissolved after the notice is published in the Official Gazette.</p>

                                <p class="paragraph">Every manager, director, or other official exercising any power of management, as well as every member of the dissolved company, retains their liability, which can be enforced as if the business had not been dissolved.</p>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p class="text-dark">The procedure for striking out company names by the ROC or voluntarily by the company is outlined in sections 248 to 252 of the Companies Act, 2013 ('Act'). The removal of a company's name from the register expedites the closure of a defunct business. It is the most straightforward method of dissolving a corporation.</p>

                                    <p class="text-dark">
                                    The ROC will ensure that suitable provisions are made for the payment or discharge of company liabilities, the realisation of funds owed to the company and its obligations within a reasonable period before granting an order of company dissolution and striking off the company name.
                                    </p class="text-dark">

                                    <p class="text-dark">In this regard, the ROC will also seek the required assurances from the director, managing director, or other persons in charge of the company's management.</p>

                                    <p class="text-dark">
                                    Even after the date of the order removing the firm name from the Register of Companies, the company's assets will be available for the discharge or payment of its obligations and liabilities.
                                    </p>
