        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">INTELLECTUAL PROPERTY RIGHTS</h1>
                        <p class="title-desc">In India, design registration is a kind of intellectual property protection in which a newly created design is put to an industrially produced object to protect it from duplication. </p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">INTELLECTUAL PROPERTY RIGHTS</p>
                    <h2 class="heading-title">WHAT ARE THE INTELLECTUAL PROPERTY RIGHTS IN INDIA?</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">As intellectual property is such a vital asset for any business, it is critical to understand how to use, protect, guard and defend the rights to intellectual property that an individual or his company holds. Intellectual property refers to the production of tangible assets related to a company's operations. In India, intellectual property refers to a person's or company's trademark, idea, design, or any other type of creation over which they have legal control. Almost every business has Intellectual Property, which can be considered a corporate asset.</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-5">
...
<section class="features features-1 bg-overlay bg-overlay-theme2" id="features-1">
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <h2 class="heading-title">Intellectual property rights include the following common types:

                    </h2>
                    <p class="heading-desc"> <b>COPYRIGHT</b><br> Grants the protection of written or published works such as books, songs, films web content, and other artworks. A copyright is a set of rights that are automatically granted to someone who creates an original work of authorship, such as a book, music, film, or piece of software. These rights include the ability to duplicate the work, create derivative works, distribute copies, and publicly perform and show it.</p>



                    <p class="heading-desc"> <b>PATENTS</b><br> An innovation can be registered for a patent in India. By getting a patent, the government grants an individual or a business the right to prevent others from using, selling, or importing the patented product or process without the approval or cooperation of the patent owner.</p>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    

                    <p class="heading-desc">A careful analysis is required to determine whether the product is unique, novel, or has an industrial application. To see if an object or innovation is the same, a person can conduct a detailed search on the Intellectual Property Regulatory Authority of India's website. Get expert assistance from our trademark consultants to avoid lengthy procedures.</p>
                    <p class="heading-desc"> <b>DESIGN</b><br>In India, design registration is a kind of intellectual property protection in which a newly created design is put to an industrially produced object to protect it from duplication. By registering a design, the author of the design is granted exclusive rights for a period of ten years, which can be extended for another five years.</p>

                    <p class="heading-desc">Any shape, arrangement, pattern, or decoration, as well as a composition of lines and colors, can be registered as a design in India under the Design Act of 2000.</p>

                    <p class="heading-desc"> <b>TRADEMARKS</b><br>A trademark protects signs, symbols, logos, words, or sounds that distinguish between the products and services from the competitors. In India, trademark registration allows a trademark owner to use symbols or words to symbolize a company or the products it sells. Once a trademark is registered, no one else can use it for as long as it is in use.</p>
