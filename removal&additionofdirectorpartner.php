        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-7">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">REMOVAL & ADDITION OF DIRECTOR/PARTNER</p>
                    <h2 class="heading-title">
                        The director has the function to oversee, manage or direct the company to go in the correct direction.</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">For a public limited company, 2/3 rd of the shareholders appoint the director and the rest of the directors are appointed as per the provisions related to the articles of association of the company. The remaining portion of the directors represents 1/3 of the directors.</p>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p class="paragraph">For a private limited company, the appointment is carried out by looking into the provisions prescribed by the articles of association of the company. If there are no provisions related to this then the appointment of the directors is carried out through the shareholders.</p>
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <h2 class="heading-title">
                        Points to Remember before considering change in directors</h2>

                    <p class="heading-desc">Private Limited Company- The minimum amount of directors in a private limited company is two..</p>

                    <p class="heading-desc">
                        Public Limited Company- The minimum amount of directors in a public limited company is seven..</p>

                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <p class="heading-desc">The director who is resigning must submit the resignation letter to the board of directors. Within 30 days of resigning the director has to file Form DIR-11 to the registrar of companies.</p>

                    <p class="heading-desc">There are 15 directors allowed for a private limited company.</p>
                    <p class="heading-desc">Every director who is appointed as per the provisions of the Companies Act, 2013 has to have a Director Identification Number (DIN)..</p>
                    <p class="heading-desc">Foreign directors are allowed to be appointed in both private and public companies.</p>
                    <p class="heading-desc">
                        Any director who is removed formally from the board must secure an opportunity to be heard.</p>
