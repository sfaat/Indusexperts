        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">Secretarial Services</h1>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card p-1 my-2">
                    ...
                    <div class="card p-1 my-4">
                        <div class="card-body" style="font-size: 20px; font-family:Georgia, 'Times New Roman', Times, serif; color: black;">
                        Obtaining of approvals/permissions from MCA/Regional Director(RD)/Registrar of Companies (ROC) under various provisions of the Companies Act, 2013.
                        </div>
                    </div>
                    ...
                    <div class="card p-1 my-4">
                        <div class="card-body" style="font-size: 20px; font-family:Georgia, 'Times New Roman', Times, serif; color: black;">
                        Holding & Conducting of Annual General Meeting, Extra Ordinary General Meeting & Board Meetings for Client Companies.
                        </div>
                    </div>
                </div>
