        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">SOCIETY /TRUST REGISTRATION</h1>
                        <p class="title-desc">A non-governmental organisation (NGO) is an organisation with a specific cultural, educational, economic, religious, or social goal. Because they are not owned by anyone, they are unable to disperse their profits or surplus in this manner.</p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-7">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">SOCIETY /TRUST REGISTRATION</p>
                    <h2 class="heading-title">Whatever profit or surplus they may generate from economic activity is re-invested or spent on relevant non-profit initiatives</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">Whatever profit or surplus they may generate from economic activity is re-invested or spent on relevant non-profit initiatives. Donations, grants, gifts, membership fees, and interest on investment are common sources of revenue for non-profit organisations." Nowadays, the term NGO refers to registered trusts, societies, cooperative societies, endowments, non-profit corporations, and other organisations that work for the welfare, development, and progress of the general public and, in some ways, supplement the state's similar functions, and are thus referred to as Non-Governmental Organizations (NGOs).</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p class="text-dark"><b>WHAT IS TRUST</b></p>
                                    <p class="text-dark">In India, a public charity trust is one of the non-profit entities that can be established. Public charitable trusts are commonly established for a variety of objectives, including poverty assistance, education, medical relief, recreation facilities, and any other object of wide public usefulness. In most cases, public trusts are irrevocable.
In order to be eligible to seek for tax-exemption, a public charity trust must typically register. 
</p>
...
<section class="features features-1 bg-overlay bg-overlay-theme2" id="features-1">
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <h2 class="heading-title">WHAT IS SOCIETY</h2>
                    <p class="heading-desc">Societies are membership groups with the potential to be registered as charity organisations. Trusts and societies have a lot in common, but there are a few key differences. While only two people are necessary to start a trust, at least seven people are required to form a society. To be able to apply for tax-exempt status, the applicants must first register the organisation with the state Registrar of Societies in their jurisdiction. A governing council or a managing committee is normally in charge of running a society. In general, Indian citizens serve on the managing committee or governing council of societies, despite the fact that the Societies Registration Act does not ban non-natural legal people or foreigners from doing so. The Societies Registration Act of 1860 governs societies.</p>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <h2 class="heading-title">PROCEDURE</h2>
                    <p class="heading-desc">A society can be formed by a group of at least seven people. Apart from Indian citizens, companies, foreigners, and other registered societies can also register for the society's Memorandum of Association.</p>
                    <p class="heading-desc">In the same way that Partnership firms can be unregistered or registered, so can societies. Only registered societies, on the other hand, will be able to endure consigned properties and/or have an ensemble filed against or by them..</p>
                    <p class="heading-desc">State governments are in charge of society registration. As a result, the application for society registration must be submitted to the specific authority of the state in where the society's registered office is located. The founding members of a society must first agree on the name of the society, then create the Memorandum, and finally register the society.</p>
