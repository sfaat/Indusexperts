        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">DIR-3-KYC</h1>
...
DIR-3-KYC
                    ...
                    <h2 class="heading-title">Following is the list of required documents to file DIR-3 KYC:.</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">This form will be used to update the KYC of all directors. As per the provisions of Rule 12A of the Companies Appointment and Qualification of Directors) Rules, 2014, every individual who is allotted DIN as of 31st March of a financial year must submit his KYC on or before 30th September of the immediately next financial year.</p>
                                <ul class="list-unstyled advantages-list">
                                        <li>Proof of permanent address- Copy of Electricity Bill, Aadhaar Card</li>
                                        <li>Copy of Aadhar card & Passport are mandatory if it is assigned </li>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    ...
                                    <ul class="list-unstyled advantages-list">
                                        <li>Form INC-20A</li>
                                        <li>Appointment of the Auditor (Form ADT-1)</li>
                                        <li>Form AOC-4</li>
                                        <li>Form MGT-7</li>
                                    </ul>
                                </div>
