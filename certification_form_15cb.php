                    ...
                    <div class="slide-content">
                        <div class="row">
                            <div class="col-12 col-lg-7">
                                <h1 class="slide-headline">CERTIFICATION  WORK</h1>
                                <p class="text-white" style="font-size: 19px; font-weight: 10px;">The issue of certificates to the customer, which are required for various reasons under specific applicable rules and regulations, is one of the most extensive and vital professional services.</p>
                                <!-- <ul class="slide-list advantages-list advantages-list-white">
                                    <li>A certificate from a chartered accountant is also necessary for Form 15CB.</li>
                                    <li>The purpose of Form 15CB is to determine the tax .</li>
                                    <li>TDS is imposed once again.</li>
                                </ul> -->
                ...
                <div class="panels-container">
                    <div class="panel-action">
                        ...
                        <div class="panel-content">
                            <h6 class="panel-heading">The purpose of Form 15CB is to determine the tax deduction in accordance with income tax rules </h6>
                            <p class="panel-desc">A certificate from a chartered accountant is also necessary for Form 15CB.</p>
                        </div>
                    </div>
                </div>
            </div> -->
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="about-block">
                    <div class="block-left">
                        <p class="paragraph">All remittances of a foreign nature made to a Non-Resident have been subjected to severe national laws. There are certain tax slabs and quantities that are taxed. A Form 15CA must be deposited online by the person making the remittance. A certificate from a chartered accountant is also necessary for Form 15CB.</p>
                        <p class="paragraph">The purpose of Form 15CB is to determine the tax deduction in accordance with income tax rules while also avoiding double taxation. When the remittance is taxable, TDS is imposed once again. The information provided in Form 15CB primarily includes the remittee's information, the remitter's information, the nature of the remittance (royalty, salary, commission) as agreed upon by both parties, the remitter's Tax Residency Certificate, and the remitter's bank information if DTAA (Double Taxation Avoidance Agreement) is applicable.</p>
            ...
            <div class="col-12 col-lg-5 offset-lg-1">
                <div class="about-img">
                    <div class="about-img-holder bg-overlay">
                        <div class="bg-section"><img src="assets/images/about/senior-adults-reading-holding-certificate-concrpt-2021-08-26-23-58-31-utc.jpg" alt="about Image" /></div>
                    </div>
        ...
        <div class="heading heading-13 text-center">
            <div class="row">
                <div class="col-12 col-lg-6 offset-lg-3">
                    <p class="heading-subtitle">TCS </p>
...
<!-- <section class="features features-2 bg-overlay bg-overlay-theme2" id="features-2"> -->
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <!-- <div class="row">
                <div class="col-12 col-lg-5">
                    <h2 class="heading-title">TCS</h2>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <p class="heading-desc">TCS (Tax Collected at Source) is a tax that a seller must pay and collects from the buyer at the moment of sale. The list of items on which the seller must collect tax from buyers is listed in Section 206 of the Income Tax Act.</p>
                    
                    <div class="actions-holder"><a class="btn btn--primary btn--inversed" href="#">
                            get started<i class="energia-arrow-right"></i></a><a class="btn btn--bordered btn--white" href="#">explore our plans</a></div>
                </div>
            </div> -->
