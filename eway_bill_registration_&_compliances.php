        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">EWAY BILL REGISTRATION & COMPLIANCES </h1>
                        <p class="title-desc">A waybill is a receipt or document provided by a carrier that contains information and instructions on the shipment of a consignment of goods, such as the name of the consignor, consignee, point of origin, destination, and route. </p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">GST REGISTRATIONEWAY BILL REGISTRATION & COMPLIANCES </p>
                    <!-- <h2 class="heading-title">EWay Bill is an electronic way bill that can be generated on the eWay Bill Portal for the movement of goods. </h2> -->
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="block-left">
                                <p class="paragraph">Logistical speed-breakers could cost an economy several billion dollars annually. With the roll-out of Eway Bill, it is expected that a lot of bottlenecks would be eliminated from the compliance as well as operational front bringing transparency and seamless the movement of goods both within and across states. Eway Bill would reduce the amount of time which is wasted at the state borders for validating the documents relating to interstate goods movement.</p>
                                <p class="paragraph">A unique Eway Bill Number (EBN) is assigned to each eway bill and is available to the provider, recipient, and transporter.</p>
                                <p class="paragraph">EWay Bill is an electronic way bill that can be generated on the eWay Bill Portal for the movement of goods. Without an e-way bill created on ewaybillgst.gov.in, a GST registered person cannot move goods in a vehicle with a value above Rs. 50,000 (Single Invoice/bill/delivery challan).</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p>Alternatively, an Eway bill can be produced or cancelled through SMS, Android App, or API site-to-site interface.</p>
