        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">Startup Registration</h1>
                        <p class="title-desc">Everyone wants to start a business in order to move on with this desire and make it a reality. As a result, business formation is possible in India. You can start your business legally by incorporating a company, which provides you with not just a growing framework but also government aid.</p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-7">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">Startup Registration</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph"> 1. The very first step for Section 8 company registration is to prepare DSC. Apply for Digital Signature Certificate (DSC) as soon as possible.</p>
                                ...
                                <p class="paragraph">Let's have a look at the concept of a corporation before we go into the company registration. A company is a legal body that consists of at least two directors as well as members/shareholders. </p>
                                <p class="paragraph">It is a legal business entity that was formed in accordance with the Company Act of 2013's online registration rules.</p>
                                <p class="paragraph">3. After getting approval from the regional director, we will proceed to file the section 8 company registration application with the requisite documents before ROC.
                                    Once all clarifications are provided to ROC, the ROC shall issue a Certificate of Incorporation along with a Company Identification Number (CIN).</p>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    ...
                                    <p class="paragraph">4. Once you get the License, you need to draft the Memorandum of Association (MoA) and Article of Association (AoA) to file section 8 company registration applications.
                                        The Object of the company will be detailed in the MoA and the rules, and the by-laws will be mentioned in the AoA.</p>
                                    <p class="paragraph">5. You must have your PAN, TAN and bank account ready while going for Section- 8 Company registration in India.</p>
