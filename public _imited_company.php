        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">PUBLIC LIMITED COMPANY</h1>
                        <p class="title-desc"><br>
        ...
        <div class="row">
            <div class="col-12 col-lg-5">
                <div class="about-img">
                    <div class="about-img-holder bg-overlay">
                        <div class="bg-section"><img src="assets/images/about/Public-company.jpg" alt="about Image" /></div>
                    </div>
                    <div>
                    </div>
                </div>
            ...
            <div class="col-12 col-lg-7">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">PUBLIC LIMITED COMPANY</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12" style="text-align: justify">
                            <div class="block-left">
                                <p class="paragraph">If you wish to obtain funds from the general public through an Initial Public Offering ("IPO"), a public limited company should be your first choice in India because public limited firms have special access to the capital market under Indian securities laws. In India, public limited companies are thought to be a more transparent business model than other corporate structures.
                                </p>
                                <p class="paragraph">It allows investors to sell their shares and transfer their ownership in the company without any problem.
                                    Because there are sectors open for public limited firms to seek foreign loans and equity participation under Foreign Exchange Laws, public limited corporations in India are a destination point for Foreign Direct Investment ("FDI").</p>
                            ...
                            <div class="block-right">
                                <div class="prief-set">
                                    <ul class="list-unstyled advantages-list">
                                        <li class="text-dark">Private Company Limited by shares</li>
                                        <li class="text-dark" style="line-height: 20px;">Private Company Limited by Guarantee</li>
                                    </ul>
                                </div>
                            </div>
                        </div> -->
...
<section class="about about-1" id="about-1" style="padding: 5px;">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-12" style="padding: 25px;">
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-12" style="text-align: justify">
                            <div class="block-left">
                                ...
                                <p class="paragraph">In the eyes of the law, public companies are reputed when it comes to borrowing money from banks and other financial institutions. An added advantage of being a public company would give the company recognition.</p>
                                <p class="paragraph" style="font-weight: 600;">
                                    Separate Legal Entity
                                </p>
                                <p class="paragraph">The principle of separate legal entity is enjoyed by the directors and shareholders (members) of a public limited company. This means that the liability of the members and directors is only limited to a specific amount. Creditors cannot approach the members in case of any debts owed by the public company.</p>
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="block-left">
                                <div class="prief-set">
                                    ...
                                    <ul class="list-unstyled advantages-list">
                                        <li class="text-dark"> Minimum 3 Directors</li>
                                        <li class="text-dark">Maximum 15 Directors required</li>
                                        <li class="text-dark">At least one director should be an Indian resident.</li>
                                        <li class="text-dark">2 Shareholders required (minimum).</li>
                                    </ul>
                                ...
                                <ul>
                                <p class="paragraph"> Choosing a unique name for the company</p>
                                <p class="paragraph">Reserving the name of the Public Limited company using RUN application</p>
                                <p class="paragraph">Obtaining the DSC and DIN of the directors of the company</p>
                                <p class="paragraph"> Drafting MOA and AOA of the company</p>
                                <p class="paragraph">Submitting the online application for Public Limited company incorporation</p>
                                <p class="paragraph">Assessment of the application by the Ministry of Corporate Affairs</p>
