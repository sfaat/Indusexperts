        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">CHANGE IN NAME & PLACE OF COMPANY</h1>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">CHANGE IN NAME & PLACE OF COMPANY</p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12" style="text-align: justify">
                            <div class="block-left">
                                <p class="paragraph">When you name an entity, you may feel like you are naming its children. You can only get one shot, so it's better to get it right from the beginning. But that's not really true. Some kids grow up and change their names, and  growing businesses can do the same with some strategic thinking. A legal entity is an artificial person whose name derives its clear and legal identity. The name of the company reflects the existence of its independent entrepreneur. Sooner or later, the time will come when  corporate identity will be out of date. You may need to update certain entity information using ROC. One of these requirements is the renaming of the company in India. The company name is subject to change in accordance with the procedures stipulated in the Companies Act 2013.


                                </p>
                                <p class="text-dark" style="font-weight: bold;">Eligibility Criteria for Change Company Name</p>
                                <p class="text-dark" style="font-weight: bold;">Following are the reasons people often find themselves eligible to change the name of their companies</p>
                            ...
                            <div class="block-right">
                                <div class="prief-set">
                                    ...
                                    <ul class="list-unstyled advantages-list">
                                        <li class="text-dark">Allows room for growth</li>
                                        <li class="text-dark" style="line-height: 20px;">Unique Identity</li>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-12" style="text-align: justify">
                            <div class="block-left">
                                ...
                                <p class="paragraph" style="font-weight: 600;">
                                In regard to the Change in Name of the Entity following documents are needed:
                                </p>
                            </div>
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    <ul class="list-unstyled advantages-list">
                                        <li class="text-dark">Board Resolution for change Name clause of MOA of the Company</li>
                                        <li class="text-dark">Board Resolution for Notice of EGM of the Company.</li>
                                        <li class="text-dark">Notice of EGM with explanatory Statement.</li>
                                        <li class="text-dark">Special Resolution for alter name clause of MOA.</li>
                                        <li class="text-dark">Altered MOA & AOA.</li>
                                        <li class="text-dark">Minutes of the members meeting (EGM).</li>
                                        <li class="text-dark">If change of name is due to change in main activity of the company, a certificate from chartered accountant regarding turnover details from new activity should be enclosed.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-12">
                            <div class="block-right">
                                <div class="prief-set">
                                    <ul class="list-unstyled advantages-list">
                                        <li class="text-dark">6 Name of the Company according to preference.</li>
                                        <li class="text-dark">Reason for change name of the Company</li>
