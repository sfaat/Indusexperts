        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">Why PoSh training Is important ?</h1>
                        <p class="title-desc">
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    ...
                    <h2 class="heading-title">Why PoSh training is important ?</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-12">
                            <div class="block-left">
                                <p class="paragraph">Posh training is important to familiarize all employees with the acceptable and unacceptable behaviour at work. To create a working environment where all, members of staff are treated with dignity curtesy and respect.To sensitise managers to maintain the company as equal opportunity employer and restrain from any favouritism. Guarantee protection from any victimisation or reprisals. Encouraging the reporting of behaviours which branches the sexual harassment policy. Promote appropriate standard of conduct at all time. Make employees aware of the procedure to register a complaint, if they encounter any harassment issue at workplace. Provide an effective procedure for complaints, whenever required. Inform employees about the internal complaints and its role in case a conflict arises. Treat all complaints in sensitive timely and confidential manner.</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-5">
