        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">ROC Annual Filing.</h1>
                        <p class="title-desc">Filling of Annual Accounts: withing 30 days from AGM
                            Filling f Annual Return: Within 60 days from AGM.
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <ul class="list-unstyled advantages-list">
                                    <li>Appointment of Auditor – Form ADT-1</li>
                                   
                                    <li>Filling of Annual Accounts in XBRL mode – Form A0c-4(XBRL)</li>

                                    <li>Filing of Annual Return- Form (MGT-7)</li>

                                </ul>
                                <!-- <p class="paragraph"></p><a class="btn btn--secondary" href="page-about.html">read more <i class="energia-arrow-right"></i></a> -->
                            </div>
                        </div>
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p></p>
                                    <ul class="list-unstyled advantages-list">
                                        <li>Filling of Cost Audit Report Form CRA-4</li>
                                        <li>Filing of resolutions with MCA regarding Board Report and Annual Accounts </li>
                                        <li>Form MGT-14</li>
