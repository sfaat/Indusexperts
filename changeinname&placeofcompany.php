            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        ...
                        <p class="title-desc">change of Company Name?
                            change in Place of Company or Registered office
                            Enhancement of Authorized Capital
                            Resignation/Removal of Directors
                            Form DPT-3
                            Form INC 20A
                            Forms related to charges i.e. CHG-1, CHG-2, etc
                            Heading?
                        </p>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">A Company has the authority to remove a Director by passing an Ordinary Resolution, given the Director was not appointed by the Central Government or the Tribunal. A Board Meeting will be called by giving seven days' notice to all the directors.
                                </p>
                                <p class="paragraph">A Company has the authority to remove a Director by passing an Ordinary Resolution, given the Director was not appointed by the Central Government or the Tribunal. A Board Meeting will be called by giving seven days' notice to all the directors.
                                </p>

                                <p class="paragraph">Directors/Partners Can Be Removed Or Added.A firm can nominate directors according to its convenience by completing Form DIR-12, which complies with the law's requirements for director rotation. A director may resign from the company at any time by giving the company written notice and filing Form DIR-11 and DIR-12.</p>
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p class="paragraph">Eligibility Criteria For Directors/Partners To Be Removed Or Added
                                        You must ensure the following to be eligible for the removal or addition of directors/partners of your company:
                                    </p>
                                    <p class="paragraph">If you're adding new partners or directors, they're qualified.
                                        The removal of directors and partners has a valid justification
                                    </p>
                                    <ul class="list-unstyled advantages-list">
                                        <li>Strike off Companies</li>
                                        <li>Companies which are under the process of Striking off</li>
                                        <li>Companies under Amalgamation</li>
                                        <li>Companies under Liquidation</li>
...
<section class="features features-1 bg-overlay bg-overlay-theme2" id="features-1">
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <h2 class="heading-title">Furnishing return with ROC in respect of outstanding payments to Micro or Small Enterprises</h2>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                    <p class="heading-desc"><b>Require to file 2 times.</b></p>
                    <ul class="list-unstyled advantages-list">
                        <li class="text-white">Initial Return for the amount outstanding.


                        </li>
                        <li class="text-white">Half Yearly Return for the amount outstanding</li>
                    </ul>
