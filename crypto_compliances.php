        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">CRYPTO  COMPLIANCES</h1>
                        <p class="title-desc">Crypto compliances are a new trend in legal. Transact and enforce agreement has been constant almost since inception of the common law. Even though the digital asset experts are eagerly waiting for well drafted digital asset agreement. Our digital asset enthusiasts are well equipped with crypto compliances and digital asset drafting. Contracts drafted with extra specifications is always keep high. </p>
        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-12">
                <div class="heading heading-1">
                    <p class="heading-subtitle heading-subtitle-bg">CRYPTO CURRENCY COMPLIANCES</p>
                    <h2 class="heading-title">LEGALITY OF CRYPTOCURRENCY.</h2>
                </div>
                <div class="about-block">
                    <div class="row">
                        <div class="col-12 col-lg-7">
                            <div class="block-left">
                                <p class="paragraph">Although cryptocurrency is not regarded legal tender in India, the operation of exchanges is. According to the chairman of the CBDT, everybody who makes money from bitcoin will have to pay taxes on it. However, there is still a lot of confusion about how cryptocurrencies are taxed. The Reserve Bank of India (RBI) barred banks and other regulated financial institutions from dealing with or issuing virtual currencies in April 2018. The ban was declared unlawful by the Supreme Court of India on March 4, 2020.</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-5">
                            <div class="block-right">
                                <div class="prief-set">
                                    <p>In the case of cryptocurrencies, fundamental analysis may also include an emerging field of data science that concerns itself with public blockchain data called on-chain metrics. These metrics can include the network hash rate, the top holders, the number of addresses, analysis of transactions, and many more. Using the abundance of available data on public blockchains, analysts can create complex technical indicators that measure certain aspects of the overall health of the network</p>
