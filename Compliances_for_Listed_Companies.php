        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">Compliances for Listed Companies</h1>
...
<section style="background-color: #566573; padding: 5px;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="jumbotron">
                <div class="card p-1 my-4">
                        ...
                        For listed firms, ensuring compliance with the provisions of the Insider Trading and SEBI Takeover Regulations, the Depositories Act, and other SEBI regulations.
                        </div>
                    </div>
                    <div class="card p-1 my-4">
                        <div class="card-body" style="font-size: 20px; font-family:Georgia, 'Times New Roman', Times, serif; color: black;">
                        For a variety of legal concerns, liaison with SEBI and stock exchanges, RBI, ROC, NSDL/CDSL, and other regulatory authorities.
                        </div>
                    </div>

                    <div class="card p-1 my-4">
                        <div class="card-body" style="font-size: 20px; font-family:Georgia, 'Times New Roman', Times, serif; color: black;">
                        Issuing certificates as an Independent Company Secretary in Practice.
                        </div>
                    </div>
