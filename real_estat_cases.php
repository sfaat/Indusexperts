        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-5">
                    <div class="title">
                        <h1 class="title-heading">REAL ESTATE REGULATION AUTHORITY</h1>
                        <p class="title-desc">In a nutshell, Real Estate Regulation Authority represents transparency in the real estate business and eradicates the existing discrepancies and problems within the real estate sector. </p>
...
<section class="about about-1 py-3 my-3" id="about-1">
    <div class="container">
        <div class="row">
            <!-- <div class="col-12 col-lg-5">
                <div class="about-img">
...
<section class="features features-1 bg-overlay bg-overlay-theme2 py-3 my-3" id="features-1">
    ...
    <div class="container">
        <div class="heading heading-2 heading-light heading-light2">
            ...
            <div class="row">
                <div class="col-12 col-lg-5">
                    <h2 class="heading-title">KEY BENEFITS OF RERA.</h2>
                    <p class="heading-desc">RERA has brought about a positive change in every facet of the real estate sector. Like as;.</p>
                    <p class="heading-desc">RERA aims to reduce project delays and property fraud. To do so, authorities have made it mandatory for all builders/developers to carry out RERA registration before they start a project.</p>
                </div>
                <div class="col-12 col-lg-6 offset-lg-1">
                   
                    <p class="heading-desc">RERA has been subdivided into smaller regulatory bodies, each of which looks after the real estate development in a
                        single state or union territory in India.
                    </p>
                    <p class="heading-desc">RERA rules apply to both residential and commercial properties.</p>
                    <p class="heading-desc">The standardization brought about by RERA aims to protect the interests of buyers and developers alike</p>
                    <p class="heading-desc">The RERA Act has brought about more accountability and transparency within the real estate industry.</p>
